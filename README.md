...
> 💡 Ensure your webcam is active and your hand is positioned 30–60 cm away in a well-lit environment for optimal detection.
...
- 🖱️ **Cursor Movement** – *(screenshot to be added)*
- 👆 **Left Click** – *(screenshot to be added)*
- 🔍 **Zoom In/Out** – *(screenshot to be added)*
- 🔃 **Scroll** – *(screenshot to be added)*
- 📸 **Screenshot** – *(screenshot to be added)*

---

## 🔭 Future Enhancements

- ✋ Multi-hand support for drag-and-drop, multitouch gestures  
- 🧠 ML integration for dynamic gesture recognition (e.g., swipes, waves)  
- ⚙️ User interface for custom gesture training  
- 🌐 Cross-platform GUI and browser-based integration (OpenCV.js, Electron)
